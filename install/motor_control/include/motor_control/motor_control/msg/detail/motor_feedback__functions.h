...
#ifndef MOTOR_CONTROL__MSG__DETAIL__MOTOR_FEEDBACK__FUNCTIONS_H_
#define MOTOR_CONTROL__MSG__DETAIL__MOTOR_FEEDBACK__FUNCTIONS_H_
 ...
 * calls
 * motor_control__msg__MotorFeedback__init().
...
/**
 * It calls
 * motor_control__msg__MotorFeedback__fini()
 ...
 * motor_control__msg__MotorFeedback__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * motor_control__msg__MotorFeedback__Sequence__fini()
 * on the array,
...
#endif  // MOTOR_CONTROL__MSG__DETAIL__MOTOR_FEEDBACK__FUNCTIONS_H_
